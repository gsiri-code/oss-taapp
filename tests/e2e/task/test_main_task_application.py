...
def test_main_script_handles_no_credentials_gracefully(tmp_path: Path) -> None:
    ...
    with (
        ...
        patch.object(gtask_client_impl.GTaskClient, "TOKEN_PATH", str(dummy_token_path)),
        patch.object(gtask_client_impl.GTaskClient, "CREDENTIALS_PATH", str(dummy_credentials_path)),
